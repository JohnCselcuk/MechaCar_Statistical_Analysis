...
Click here to view the R-script: [MechaCarChallenge.RScript](https://github.com/JohnCselcuk/MechaCar_Statistical_Analysis/blob/main/R_Analysis/MechaCarChallenge.R)
